  ...
  (n.event = {
    ...
    l.submit ||
      (n.event.special.submit = {
        ...
        teardown: function () {
          return (
            !n.nodeName(this, "form") && void n.event.remove(this, "._submit")
          );
        },
      }),
    l.change ||
    ...
    if (
      ...
      for (i = n.map(ea(k, "script"), Da), h = i.length; m < o; m++)
        (g = k),
          ...
          c.call(a[m], g, m);
      if (h)
        for (j = i[i.length - 1].ownerDocument, n.map(i, Ea), m = 0; m < h; m++)
          (g = i[m]),
            _.test(g.type || "") &&
  ...
  n.extend({
    ...
    n.each(["height", "width"], function (a, b) {
      n.cssHooks[b] = {
        get: function (a, c, d) {
          if (c)
            return Xa.test(n.css(a, "display")) && 0 === a.offsetWidth
              ? Pa(a, Za, function () {
                  return fb(a, b, d);
                })
              : fb(a, b, d);
    ...
    (n.cssHooks.marginRight = Ua(l.reliableMarginRight, function (a, b) {
      if (b) return Pa(a, { display: "inline-block" }, Sa, [a, "marginRight"]);
    })),
  ...
  (n.offset = {
    ...
    n.each(["top", "left"], function (a, b) {
      n.cssHooks[b] = Ua(l.pixelPosition, function (a, c) {
        if (c)
          return (c = Sa(a, b)), Oa.test(c) ? n(a).position()[b] + "px" : c;
      });
    }),
