...
$(document).ready(function () {
  var e =
    ...
    '<div class="sw-image">' +
    '<a href="#">' +
    '<img src="assets/img/wordpress-version.png" alt="img"/>' +
    "</a>" +
    ...
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/1.png"><img src="assets/img/pattern/1.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/2.png"><img src="assets/img/pattern/2.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/3.png"><img src="assets/img/pattern/3.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/4.png"><img src="assets/img/pattern/4.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/5.png"><img src="assets/img/pattern/5.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/6.png"><img src="assets/img/pattern/6.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/7.png"><img src="assets/img/pattern/7.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/8.png"><img src="assets/img/pattern/8.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/9.png"><img src="assets/img/pattern/9.png" alt="image"></a>' +
    '<a href="#" class="sw-pattern" data-image="assets/img/pattern/10.png"><img src="assets/img/pattern/10.png" alt="image"></a>' +
    "</div>" +
    '<div class="clearfix"></div>' +
    "</div>" +
    "</div>";
...
var switchColor = {
  ...
  setColor: function (e) {
    ...
    $(t.headLink).attr("href", "assets/css/colors/" + e + ".css");
